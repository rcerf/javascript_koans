describe("About Functions", function() {
  ...
  it("should use lexical scoping to synthesise functions", function () {
    ...
    //is the numberToIncrease = 3 in the first argument or is increaseByAmount = 3? I think numberToIncrease = 10.
  ...
  it("should use function body as a string", function () {
    ...
    //how does this work? I don't understand how the syntax of add function works.
    expect(add(1, 2)).toBe(3);
